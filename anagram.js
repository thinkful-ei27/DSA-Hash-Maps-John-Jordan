...
const HashMap = require('./jordanHashMap');
const anagramHash = new HashMap();
const items = ['east', 'cars', 'acre', 'arcs', 'teas', 'eats', 'race'];

items.forEach(item => anagramHash.set(item));
console.log(anagramHash.display());
